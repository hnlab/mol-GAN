...
class TrainModelRunner:
    ...
    def __init__(self, input_data_path, output_model_folder, n_epochs, 
                 starting_epoch, save_interval, warmup, lr_init, batch_size=64,  
                 b1=0.5, b2=0.999, lambda_gp=10, n_critic=5, message=""):
    ...
    def compute_gradient_penalty(self, real_samples, fake_samples):
        ...
        alpha = self.Tensor(np.random.random((real_samples.size(0), 1))).type(self.Tensor)
